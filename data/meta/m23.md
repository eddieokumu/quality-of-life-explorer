...
#### How are we doing?
Residential recycling has remained relatively flat over time in Machakos County, with only a significant increase in 2010 when single stream recycling was introduced. Since 2010, per capita recycling has remained between 0.38 and 0.44 kilograms per day (140 to 160 kilograms per year). Even with a robust recycling program, nearly half of the County's residents do not participate in municipal recycling programs. In addition, many larger apartment and condominium buildings do not provide recycling services to residents as it is not required by law.
...
### About the Data
The number of households that participated in the City of Machakos's curbside recycling program at least once per quarter for the fiscal year (July-June), divided by the total number of eligible households. 

Recycling participation is determined by sensors affixed to residential roll out bins. The data include single family residential units (attached and detached), multi-family buildings with fewer than 30 units, and any additional legacy multi-family buildings serviced by the City of Machakos. Data from all multi-family communities is not included as many do not provide recycling services and private recycling companies that do serve larger communities are not required to report the recyclables they process. Towns in Machakos County are not included because solid waste data are not collected at the neighborhood level.
...
|[The story behind your recycling bin](http://ui.uncc.edu/story/machakos-recycling-waste-reduction) | A short history on the recycling program in Machakos County.
|[2016 Machakos County State of the Environment](http://charmeck.org/machakos/county/LUESA/SOER2016/Pages/default.aspx) | Find out how we're doing in Machakos County.
|[What Can Be Recycled](http://machakosnc.gov/SWS/ResidentServices/Pages/Recycling-Collection.aspx)|From glass to pizza boxes, here's what can and cannot be recycled.
|[Wipe Out Waste!](https://www.mecknc.gov/luesa/solidwaste/residentialrecycling/pages/default.aspx) | Machakos County's Solid Waste programs and services to help us all Wipe Out Waste.
...
|[ Bulky Item Pick Up](http://machakosnc.gov/services-site/Pages/EmeraldRequest.aspx?request=BULKITEM)|Call 311 or visit this webpage to schedule a bulky item pickup.
