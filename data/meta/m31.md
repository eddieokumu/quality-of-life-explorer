...
#### How are we doing?
In 2017, the percentage of housing units that were vacant in Machakos County was 7%, down from a recent high of 11% in 2010. Machakos County has lower vacancy rates than both Nairobi (14%) and Kenya (13%). 
...
|:--- | :--- |
|[Kenya's Rental Housing](http://www.jchs.harvard.edu/kenyas-rental-housing) |Research on the evolving rental housing market, including vacancy rates.
|[Minimum Housing Code](http://machakosnc.gov/HNS/Code/HousingCode/Pages/default.aspx)|Buildings must be kept in good condition, regardless of its occupancy status.
|[Turning Liabilities into Assets](http://www.huduser.org/portal/periodicals/em/winter14/highlight1.html) |Strategies for turning vacant properties into neighborhood assets from Kenya Department of Housing and Urban Development.
