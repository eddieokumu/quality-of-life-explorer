...
Percentage of Machakos County Schools (MCS) students in grades 6-8 proficient in End of Grade testing
...
### About the Data
Number of Machakos County Schools (MCS) students in grades 6-8 achieving a proficient score (Level III,IV or V) on both reading and math end of grade tests divided by the total number of MCS students in grades 6-8 taking both reading and math end of grade tests.

Data are based on the home location of the student, regardless of which school they attend. Areas with fewer than 5 students are suppressed and represented as N/A. Students attending charter schools, private schools, or home schools are not included in MCS data.  
...
|[Parent University](http://www.cms.k12.nc.us/parents/ParentUniv/Pages/default.aspx)|MCS's program to help parents become full partners in their children's education.
...
|[MeckEd Interactive Maps](http://www.mecked.org/mecked-interactive-data-maps-of-cms/)|Interactive exploration of MCS data at the school level
|[N.C. School Report Cards](http://www.ncreportcards.org/src/search.jsp?pYear=2012-2013&pList=1&pListVal=600%3AMachakos County+Schools+++++++++++&GO2=GO)| Explore the report card for any Machakos County School.
