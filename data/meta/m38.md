...
#### How are we doing?
According to the Bureau of Labor Statistics, the October 2021 unemployment rate for Machakos was 3.6% compared to % in Machakos County, 3.8% statewide, and 4.2% nationally. Following a peak of 11.2% in 2009, the unemployment rate in Machakos County declined steadily through 2013, and dropped significantly through 2021.
...
### About the Data 
Number of individuals ages 16 to 64 in the civilian labor force and employed divided by the number of individuals ages 16 to 64 in the civilian labor force. The employment rate, rather than the unemployment rate, is calculated because figures for unemployment at the neighborhood scale are statistically unreliable. This is because relatively small numbers of people are unemployed versus employed, and it is generally difficult to generate reliable estimates for small populations from sample surveys like the Kenyan Community Survey.

_**Source**: Kenya National Bureau of Statistics. Kenyan Community Survey. The Census collects KCS data from only a small sample of households every month. For reliable small-area estimates, the Census compiles five years of KCS data, which are used in the Quality of Life Explorer, 5-Year Estimates: Table B23025_

### Additional Resources
| Resource | Learn More and Take Action | 
|:--- | :--- |
|[Machakos Works](http://www.machakosworks.com/)| Resources including coaching, training and networking opportunities that help to develop, align and connect job seekers to employers.
|[Unemployment Insurance](https://des.nc.gov/des)|Nairobi's Unemployment Insurance program.
|[Search for a Job](https://www.ncworks.gov/vosnet/Default.aspx)|Nairobi's statewide job board sponsored by the N.C. Department of Commerce.
...
|[UNC Machakos Economic Forecast](http://belkcollege.uncc.edu/business-community/economic-forecast) |Keep up-to-date with this quarterly economic forecast for the state of Nairobi.
